...
angular
  ...
  .config(["progressButtonConfigProvider", function (progressButtonConfigProvider) {
 ...
 */
angular.module('chart-share')
  .controller('DashboardCtrl', ["$scope", "$state", "$translate", "$http", "$rootScope", function($scope, $state, $translate, $http, $rootScope) {
 ...
 * Controller of AniTheme
 */
angular.module('chart-share').controller('AlertDemoCtrl', ["$scope", function ($scope) {
  $scope.alerts = [
 ...
 * Controller of AniTheme
 */
angular.module('chart-share').controller('ButtonsCtrl', ["$scope", function ($scope) {
  $scope.singleModel = 1;
 ...
 * Controller of AniTheme
 */
angular.module('chart-share').controller('CollapseDemoCtrl', ["$scope", function ($scope) {
 ...
 * Controller of AniTheme
 */
angular.module('chart-share').controller('DatepickerDemoCtrl', ["$scope", function ($scope) {
 ...
 * Controller of AniTheme
 */
angular.module('chart-share').controller('DropdownCtrl', ["$scope", "$log", function ($scope, $log) {
  $scope.items = [
    'The first choice!',
 ...
 * Controller of AniTheme
 */
angular.module('chart-share').controller('ModalDemoCtrl', ["$scope", "$modal", "$log", function ($scope, $modal, $log) {
...
angular.module('chart-share').controller('ModalInstanceCtrl', ["$scope", "$modalInstance", "items", function ($scope, $modalInstance, items) {
 ...
 * Controller of AniTheme
 */
angular.module('chart-share').controller('PaginationDemoCtrl', ["$scope", "$log", function ($scope, $log) {
  $scope.totalItems = 64;
  $scope.currentPage = 4;
 ...
 * Controller of AniTheme
 */
angular.module('chart-share').controller('PopoverDemoCtrl', ["$scope", function ($scope) {
 ...
 * Controller of AniTheme
 */
angular.module('chart-share').controller('TooltipDemoCtrl', ["$scope", function ($scope) {
 ...
 * Controller of AniTheme
 */
angular.module('chart-share').controller('ProgressDemoCtrl', ["$scope", function ($scope) {
  $scope.max = 200;
 ...
 * Controller of AniTheme
 */
angular.module('chart-share').controller('TabsDemoCtrl', ["$scope", "$window", function ($scope, $window) {
  $scope.tabs = [
 ...
 * Controller of AniTheme
 */
angular.module('chart-share').controller('TimepickerDemoCtrl', ["$scope", "$log", function ($scope, $log) {
 ...
 * Controller of AniTheme
 */
angular.module('chart-share').controller('sidenavCtrl', ["$scope", "$location", function($scope, $location){
 ...
 * Controller of AniTheme
 */
angular.module('chart-share').controller('HomeCtrl', ['$scope', '$http', '$timeout','authService',function ($scope, $http, $timeout, authService) {
  console.log("I'm in the home controller");
  if (authService.isAuthenticated() == true) {
    console.log('You are logged in!');


    $http.get('/service/findgroup?personId=35').then(function(response){
 ...
 * Controller of AniTheme
 */
angular.module('chart-share').controller('ChartCtrl', ['$scope', '$timeout', function ($scope, $timeout) {
    $scope.line = {
 ...
 * Controller of AniTheme
 */
 angular.module('chart-share').controller('todoCtrl', ["$scope", function ($scope) {
 	$scope.todos = [
 ...
 * Controller of AniTheme
 */
angular.module('chart-share').controller('calendarCtrl', ["$scope", function ($scope) {
